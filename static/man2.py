...
<a href="assembly">執行  head</a><br /><br />
...
\\-4.var components=assembly.
ListFeaturesByType(true,pfcCreate("pfcfFeatureType").FEATTYPE_COMPONENT);
//此一featID為組立件中的第1個零件編號，也就是樂高人偶的body
\\--4.var first_featID=components.Item(0).Id;
接著,把函氏中fearID改成first_featID
var featID = three_plane_assembly(session, assembly, transf, first_featID, 0, "LEGO_BODY.prt", "ASM_TOP", "ASM_FRONT", "ASM_RIGHT", "TOP", "FRONT", "RIGHT"); 
